  ...
  return (
    <div className="mt-4 flex items-center gap-2 text-sm">
      <div className="flex flex-wrap items-center gap-2">
        <span className="inline-flex items-center gap-1 rounded bg-stone-700 px-2 py-0.5 text-xs text-gray-400 capitalize">
          {timeClass}
        </span>
        <span className="inline-flex items-center gap-1 rounded bg-stone-700 px-2 py-0.5 text-xs text-gray-400">
