...
export default function Sidebar({ isSidebarOpen, closeSidebar }) {
  ...
  return (
    <Drawer
      ...
      className="fixed top-0 left-0 z-40 h-screen w-64 border-r border-gray-200 bg-white pt-14 transition-transform dark:border-gray-700 dark:bg-gray-800"
    >
      ...
      <div className="absolute bottom-0 left-0 z-20 hidden w-full justify-center space-x-4 bg-white p-4 dark:bg-gray-800">
        <NavLink
          to="/settings"
